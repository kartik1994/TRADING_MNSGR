...
def LONDON(dat,params, ids, tickerId, histId, london_df,london_log):
    tp_buy = 0
    tp_buy2 = 0
    tp_sell = 0
    tp_sell2 = 0
    ...
    if london_list.index(params[0]) > 5:
        ...
        london_log.loc[
            london_log.CURRENCY == params[0], ["TP_BUY", "TP_BUY2", "TP_SELL", "TP_SELL2", "BUY_QTY", "SELL_QTY",
                                               "ENTRY_FILLED", "ENTRY_REMAIN","ENTRY_SIGNAL","ENTRY_TYPE","EXE_TIME","CLOSE","ENTRY_EXE"]] = float(tp_buy), float(tp_buy2), float(
            tp_sell), float(tp_sell2), "0", int(params[2]), int(entry_result[2]), int(entry_result[3]),entry_result[6],entry_result[5],entry_result[4],float(close_data),entry_result[0]
    ...
    if ny_list.index(params[0]) >= 7:
        ny_log.loc[
            ...
            tp_sell), float(tp_sell2), int(params[7]), int(params[6]), int(entry_result[2]), int(entry_result[3]), \
                                                                    entry_result[6], entry_result[5], entry_result[
                                                                        4], float(close_data), entry_result[0]
    elif 3 < ny_list.index(params[0]) < 7:
        ny_log.loc[
            ny_log.CURRENCY == params[0], ["TP_BUY", "TP_BUY2", "TP_SELL", "TP_SELL2", "BUY_QTY", "SELL_QTY",
                                           "ENTRY_FILLED", "ENTRY_REMAIN", "ENTRY_SIGNAL", "ENTRY_TYPE", "EXE_TIME",
            ...
            tp_sell), float(tp_sell2), "0", int(params[2]), int(entry_result[2]), int(entry_result[3]), entry_result[6], \
                                                                    entry_result[5], entry_result[4], float(close_data), \
                                                                    entry_result[0]
...
def run_london():
    ...
    if shortsum > 1 and longsum > 1:
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'AUD.NZD', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,AUDNZD_params, ids, 100, 200, london_df,london_log)).start()
        ################################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'CHF.NOK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,CHFNOK_params, ids1, 300, 400, london_df,london_log)).start()
        ###############################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'CHF.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,CHFSEK_params, ids2, 500, 600, london_df,london_log)).start()
        ##########################################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'NZD.CHF', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,NZDCHF_params, ids3, 700, 800, london_df,london_log)).start()
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'GBP.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,GBPSEK_params, ids4, 900, 1000, london_df,london_log)).start()
        ###############################################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'EUR.NZD', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,EURNZD_params, ids5, 1100, 1200, london_df,london_log)).start()
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'EUR.NOK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,EURNOK_params, ids6, 1200, 1300, london_df,london_log)).start()
        ##############################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'EUR.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,EURSEK_params, ids7, 1400, 1500, london_df,london_log)).start()
        ##################################################################
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'GBP.NOK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,GBPNOK_params, ids8, 1600, 1700, london_df,london_log)).start()
        ...
        if (0 <= df_switch.loc[df_switch.CURRENCY == 'NOK.SEK', 'TP1'].iloc[-1] <= 0.25) and \
            ...
            Thread(target=LONDON, args=(dat,NOKSEK_params, ids9, 1800, 1900, london_df,london_log)).start()
        ########################
    return
