...
class contract():
    ...
    def create_order(self, account, orderType, totalQuantity, action, lmt, transmit,tif,gtd):
        order = Order()
        ...
        # order.m_trailingPercent=perc
        # order.m_hidden=hidden
        # order.m_percentOffset=off
